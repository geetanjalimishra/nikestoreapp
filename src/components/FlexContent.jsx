      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 shadow-slate-900 text-slate-100 py1.5"
            >
              {btn}
            </button>
          </a>
        </div>
        <div className="flex items-center justify-center max-w-xl relativ lg:max-w-none w-full">
          <img
            src={img}
            alt="img/${heading}"
            className={`w-auto object-fill transitions-theme ${
              ifExists
                ...
                : "h-72 lg:h-64 md:h-60 sm:h-48 xsm:h-40 rotate-[15deg] hover:rotate-12"
            }`}
          />
        </div>
      </div>
